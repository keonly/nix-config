  ...
  config = lib.mkIf config.hyprland.enable {
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bindd = [
          "$mod, A, Toggle left sidebar, global, quickshell:sidebarLeftToggle"
          "$mod, N, Toggle right sidebar, global, quickshell:sidebarRightToggle"
          "$mod, Slash, Toggle cheatsheet, global, quickshell:cheatsheetToggle"
          "$mod, K, Toggle on-screen keyboard, global, quickshell:oskToggle"
          "Ctrl+Alt, Delete, Toggle session menu, global, quickshell:sessionToggle"
          "$mod, V, Clipboard history >> clipboard, global, quickshell:overviewClipboardToggle"
          "$mod, Period, Emoji >> clipboard, global, quickshell:overviewemojitoggle"
          "$mod, Space, Toggle overview, global, quickshell:overviewToggleRelease"
          "$mod, Tab, Toggle overview, global, quickshell:overviewToggle"
        ];
